...
embbidings = np.load('embeddings.npy', allow_pickle=True).tolist()
new_labels = np.load('new_labels.npy', allow_pickle=True).tolist()
...
# Define callbacks
checkpoint = ModelCheckpoint('distbert_emb2BiLSTM2.h5', monitor='val_loss', save_best_only=True, save_weights_only=False)
